...
module.exports.onChat = async ({ api, event, message }) => {
  try {
    ...
    if (body.startsWith("baby")|| body.startsWith("milow") || body.startsWith("milow")|| body.startsWith("Mehreen")|| body.startsWith("hi") || body.startsWith("bby") || body.startsWith("raihan")|| body.startsWith("nobita") || body.startsWith("oi")) {
